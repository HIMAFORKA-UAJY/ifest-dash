            ...
            <div class="page-content-wrapper">
                <div class="page-content is-relative">
                    ...
                    <div class="page-content-inner">
                        ...
                        <!--Form Layout 1-->
                        <form method="post" action="{{env('APP_URL')}}/user/events/muc/registed_team" class="form-layout" id="confirm_muc">
                            @csrf
                            <div class="form-outer">
                                <div class="form-header stuck-header">
                                    <div class="form-header-inner">
                                        <div class="left">
                                            <h3>Pendaftaran MUC</h3>
                                        </div>
                                        <div class="right">
                                            <div class="buttons">
                                                ...
                                                <a onclick="initConfirm('Konfirmasi Data', 'Apakah data sudah benar? Data yang telah dimasukkan tidak bisa diubah kembali.', false, false, 'Daftar', 'Batal', function (closeEvent) {$('#confirm_muc').submit();})" type="submit" id="save-button" class="button h-button is-primary is-raised">
                                                    <span class="icon">
