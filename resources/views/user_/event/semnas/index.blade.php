@section('title', 'Pendaftaran SEMNAS')
<x-layouts.app>
            ...
            <div class="page-content-wrapper">
                <div class="page-content is-relative">
                    ...
                    <div class="page-content-inner">
                        ...
                        <!--Form Layout 1-->
                        <form method="post" action="{{env('APP_URL')}}/user/events/semnas/registed_team" class="form-layout" id="confirm_semnas">
                            @csrf
                            <div class="form-outer">
                                <div class="form-header stuck-header">
                                    <div class="form-header-inner">
                                        <div class="left">
                                            <h3>Pendaftaran SEMNAS</h3>
                                        </div>
                                        <div class="right">
                                            <div class="buttons">
                                                ...
                                                <a onclick="initConfirm('Konfirmasi Data', 'Apakah data sudah benar? Data yang telah dimasukkan tidak bisa diubah kembali.', false, false, 'Daftar', 'Batal', function (closeEvent) {$('#confirm_semnas').submit();})"  type="submit" id="save-button" class="button h-button is-primary is-raised">
                                                    <span class="icon">
                                        ...
                                        <div class="columns is-multiline">
                                            <div class="column is-12">
                                                <div class="field">
                                                    ...
                                                    @error('team_name')
                                                        <div class="danger-text">Nama Tim wajib diisi!</div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="column is-12">
